...
const std::unordered_map<CorrectionLevel, std::array<size_t, VERSION_ARRAY_SIZE>> BlocksCount{
...
const std::unordered_map<CorrectionLevel, std::array<size_t, VERSION_ARRAY_SIZE>> CorrBlockBytes{
...
const std::unordered_map<size_t, std::vector<size_t>> GeneratingPolynomial{
...
const std::array<uint8_t, 256> GaloisField{
...
const std::array<std::vector<size_t>, VERSION_ARRAY_SIZE> LevelingPatterns{
...
const std::array<uint32_t, VERSION_ARRAY_SIZE> VersionCode{
    0, 0, 0, 0, 0, 0,
...
const std::array<std::function<uint8_t(size_t, size_t)>, MASK_ARRAY_SIZE> MaskFunctions{
...
const std::unordered_map<CorrectionLevel, std::array<size_t, MASK_ARRAY_SIZE>> CorrectionLevelMaskCode{
